...
@Slf4j
@Component
public class GroupCatEachNowStatisticCommand extends PlannerBaseCommand {
    ...
    public GroupCatEachNowStatisticCommand() {
        super("statcateachnow", "(получить статистику. Без aтрибутов - статистика за месяц.)\nАтрибуты:\n &lt;after&gt; &lt;before&gt; (dd-MM-yyyy).");
    }
